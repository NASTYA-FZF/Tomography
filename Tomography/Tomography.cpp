...
// Tomography.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTomographyApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTomographyApp

CTomographyApp::CTomographyApp()
{
...
// Единственный объект CTomographyApp

CTomographyApp theApp;


// Инициализация CTomographyApp

BOOL CTomographyApp::InitInstance()
{
